...
pub static DATAMODEL_STR: &'static str = include_str!(
    "/Users/mycs/Desktop/projects/tauri/like-clockwork/web/server/prisma/schema.prisma"
);
...
pub mod user {
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_user { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: user struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "username")] pub username : String } [$ ($ scalar_field) , +] } } ; }
